...
int main()
{
    ...
    cout << "• int | размерность - 4 байта | от -2.147.483.648 до 2.147.483.648" << endl;
    cout << "• short | размерность - 2 байта | от -32.768 до 32.768" << endl;
    cout << "• long | размерность - 4 байта | от -2.147.483.648 до 2.147.483.648\n" << endl;
    cout << "Беззнаковые целые числа: \n" << endl;
    cout << "• int | размерность - 4 байта | от 0 до 4.294.967.295" << endl;
    cout << "• short | размерность - 2 байта | от 0 до 65.536" << endl;
    cout << "• long | размерность - 4 байта | от 0 до 4.294.967.295\n" << endl;
    cout << "2. Вещественный тип данных: \n" << endl;
    cout << "• float | размерность - 4 байта | от 3,4*10^(-38) до 3,4*10^(38)" << endl;
    cout << "• double | размерность - 8 байта | от 1,7*10^(-308) до 1,7*10^(-308)" << endl;
    cout << "• long double | размерность - 10 байта | от 3,4*10^(-4932) до 1,1*10^(4932)\n" << endl;
    cout << "3. Символьный тип данных: \n" << endl;
    cout << "• chr | размерность - 1 байта | от -128 до 126\n" << endl;
